...
import { registrationPropertyValidation }
 from "../validations/registrationPropertyValidation.js";

const router = express.Router();

// Routes for Registration Properties
router.route("/")
  .post(validateSchema(registrationPropertyValidation), createRegistrationProperty)
